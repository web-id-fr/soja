...
class MakeJWSCreatorServiceCommand extends GeneratorCommand
{
    /** @var string */
    protected $name = 'make:jws:creator';

    /** @var string */
    protected $description = 'Create a new JWSCreator class';
    ...
    {
        return $this->resolveStubPath('JWS/jws.creator.stub');
    }
